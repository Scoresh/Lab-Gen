...
\renewcommand{\classDOC}{DE Introduction to Biotechnology I, Portsmouth High School}

\renewcommand{\titleDOC}{CRISPR Biotech Lab}

\renewcommand{\authorDOC}{Daniel Sabalakov}

\input{latex_templates/basetitle2_centered.tex}

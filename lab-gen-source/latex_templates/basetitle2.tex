...
% Node(s) 3: Alderran
\node (planet) at (\basePLANETX,\basePLANETY) {\includegraphics[width=3.5cm]{images/expEDITED.png}};
\node (planet) at (\basePLANETX,\basePLANETY) {\includegraphics[width=3cm]{images/earthEDITED.png}};
...
\node[anchor=north west, %anchor is upper left corner of the graphic
      ...
      yshift=-9in] 
     at (current page.north west) %left upper corner of the page
     {\includegraphics[width=1.5in]{images/unh_logo.png}}; 
